...
int   FanPin = 13;    // Fan relay is connected to Pin 13.
int    FanOn = 1;     // These should match defs in python code
int   FanOff = 0;     // These should match defs in python code
    ...
    if (startbyte == 255){
      ...
      switch(whichdevice){
        ...
        case 2: // fan relay command
          if (pos==FanOn)
            digitalWrite(FanPin,HIGH); // energize fan
            else digitalWrite(FanPin,LOW); // secure fan
          break; 
      } // switch servo
